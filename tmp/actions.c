...
/*   Updated: 2024/01/26 12:47:35 by tpotilli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
! taking a fork, is_eating, thinking, dying.
...
void	event_log(char *str, t_philo *philo)
{
	...
	time = ft_get_time() - philo->data->eat_time;
...
void	eat(t_philo *philo)
{
	...
	event_log("is is_eating", philo);
	philo->eat_cont++;
	ft_usleep(philo->data->eat_time);
	philo->is_is_eating = 0;
